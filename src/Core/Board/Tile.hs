...
-- position
test1 = TestLabel "position" $ TestCase $ assertEqual "" ((1,2)) (position (Floor (1,2) True))
test2 = TestLabel "position" $ TestCase $ assertEqual "" ((0,0)) (position (Floor (0,0) False))
-- setPosition
test3 = TestLabel "setPosition" $ TestCase $ assertEqual "" ((3,4)) (position $ setPosition (Floor (1,2) True) 3 4)
test4 = TestLabel "setPosition" $ TestCase $ assertEqual "" ((3,4)) (position $ setPosition (Wall (1,2)) 3 4)
--hasTreasure
test5 = TestLabel "hasTreasure" $ TestCase $ assertEqual "" (True) (hasTreasure (Floor (1,2) True))
test6 = TestLabel "hasTreasure" $ TestCase $ assertEqual "" (False) (hasTreasure (Wall (1,2)))
test7 = TestLabel "hasTreasure" $ TestCase $ assertEqual "" (False) (hasTreasure (Floor (1,2) False))
